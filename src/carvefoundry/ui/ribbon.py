...
_ICON_CANDIDATES: dict[str, tuple[str, ...]] = {
    ...
    "measure xy": ("measure", "kruler", "view-grid"),
    "draw fixture": ("applications-engineering", "draw-rectangle"),
    "cnc preflight": ("security-high", "emblem-ok", "dialog-warning"),
    "generate toolpaths": ("system-run", "applications-engineering"),
    ...
    "fit stock": ("zoom-fit-best", "transform-scale"),
    "reset": ("view-refresh", "edit-clear-history"),
    "stock setup": ("draw-cuboid", "applications-engineering"),
    "layers": ("view-list-tree", "sidebar-show"),
    "inspector": ("document-properties",),
