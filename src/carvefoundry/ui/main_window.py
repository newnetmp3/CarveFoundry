...
class MainWindow(PlanarOperationsMixin, RibbonActionsMixin, QMainWindow):
    ...
    def _build_command_actions(self) -> None:
        ...
        specs = (
            ...
            ("vector_subtract", "Subtract Silhouettes", lambda: self._run_planar_operation("subtract")),
            ("vector_intersect", "Intersect Silhouettes", lambda: self._run_planar_operation("intersect")),
